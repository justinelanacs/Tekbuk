...
import com.example.tekbuk.databinding.ActivityDagliLevel2Binding
import java.io.BufferedReader
import java.io.InputStreamReader

class DAGLI_level2 : AppCompatActivity() {

    private val paksaId = "dagli"
    private val levelCompleted = 2
    private lateinit var binding: ActivityDagliLevel2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityDagliLevel2Binding.inflate(layoutInflater)
        ...
        val prefs = getSharedPreferences("DAGLI_level2_Progress", MODE_PRIVATE)
    ...
    private fun finishQuiz() {
        ...
        userScoresPrefs.edit().putInt("DAGLI_LEVEL_2", newHigh).apply()
