...
class DAGLI_level2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // load saved highest and attempts
        val prefs = getSharedPreferences("DAGLI_level2", MODE_PRIVATE)
        val highestScore = prefs.getInt("highest_score", 0)
        quizAttempts = prefs.getInt("quiz_attempts", 0)

        // show highest only if user already attempted at least once
    ...
    private fun shuffleQuestionsAndChoices() {
        ...
        val input = resources.openRawResource(R.raw.daglilevel2)
