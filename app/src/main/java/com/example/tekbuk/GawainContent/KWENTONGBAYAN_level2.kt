...
class KWENTONGBAYAN_level2 : AppCompatActivity() {
    ...
    private val paksaId = "kwentongbayan"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val prefs = getSharedPreferences("KWENTONGBAYAN_level2", MODE_PRIVATE)
    ...
    private fun shuffleQuestionsAndChoices() {
        ...
        val input = resources.openRawResource(R.raw.kwentongbayanlevel2)
