...
import com.example.tekbuk.databinding.ActivityKwentongbayanLevel2Binding
import java.io.BufferedReader
import java.io.InputStreamReader

class KWENTONGBAYAN_level2 : AppCompatActivity() {

    // ⭐ [FIX] Use the consistent ID with an underscore
    private val paksaId = "kwentong_bayan"
    private val levelCompleted = 2
    private lateinit var binding: ActivityKwentongbayanLevel2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        binding = ActivityKwentongbayanLevel2Binding.inflate(layoutInflater)
        ...
        val prefs = getSharedPreferences("KWENTONGBAYAN_level2_Progress", MODE_PRIVATE)
    ...
    private fun finishQuiz() {
        ...
        userScoresPrefs.edit().putInt("KWENTONG_BAYAN_LEVEL_2", newHigh).apply()
