...
class TALUMPATI_level1 : AppCompatActivity() {
    ...
    private val prefsName = "TALUMPATI_Level1_Progress"
    ...
    private val words = listOf(
        Word("PAGSUPORTA", 3, 1, "H", "Pagtangkilik."),
        Word("OBRAMAESTRA", 5, 2, "H", "Likhang sining."),
        Word("NAGBIBIGAY", 11, 2, "H", "Nag-aambag."),
        Word("MAGTULUNGAN", 2, 10, "V", "Magkaisa."),
        Word("GABAY", 3, 3, "V", "Inspirasyon.")
    )
    ...
    private fun showAlreadyCompletedDialog() {
        ...
        val savedScore = userScoresPrefs.getInt("TALUMPATI_LEVEL_1", 0)
