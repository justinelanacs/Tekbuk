...
class KwentongbayanContent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_kwentongbayan_content)
        ...
        val inputStream = resources.openRawResource(R.raw.kwentongbayan)
