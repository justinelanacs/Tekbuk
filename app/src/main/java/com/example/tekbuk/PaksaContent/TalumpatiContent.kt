...
class TalumpatiContent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_talumpati_content)
        ...
        val inputStream = resources.openRawResource(R.raw.talumpati) // replace 'myfile' with your file name
