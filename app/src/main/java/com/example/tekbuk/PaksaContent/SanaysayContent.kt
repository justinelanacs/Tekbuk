...
class SanaysayContent : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        setContentView(R.layout.activity_sanaysay_content)
        ...
        val inputStream = resources.openRawResource(R.raw.sanaysaycontent)
